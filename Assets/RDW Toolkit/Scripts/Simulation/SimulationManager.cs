...
public class SimulationManager : MonoBehaviour {
    ...
    enum AlgorithmChoice {None, S2C, S2O, Zigzag, APF, RFL, Rot};
        ...
        else
        {
            ...
            switch (condAlgorithm)
            {
                ...
                case AlgorithmChoice.RFL:
                    ...
                    algorithmName = "RFL";
                    break;
                case AlgorithmChoice.Rot:
                    redirectionManager.gameObject.AddComponent<RotRedirector>();
                    redirectorType = typeof(RotRedirector);
                    algorithmName = "Rot";
                    break;
                //case 4:
