...
public class TrailDrawer : MonoBehaviour {
    ...
    void OnApplicationQuit()
    {
        ...
        if(!redirectionManager.simulationManager.testSession)
        {
            ...
            string filePath_Real = "D:/Unity/UserData/" + ExpName +"_Real.txt";
            string filePath_Virtual = "D:/Unity/UserData/" + ExpName +"_Virtual.txt";
            string filePath_ResetTime = "D:/Unity/UserData/" + ExpName +"_ResetTime.txt";
            string filePath_RealDir = "D:/Unity/UserData/" + ExpName +"_RealDir.txt";
